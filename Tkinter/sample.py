...
def b1():
    messagebox.showinfo("Create", "Success! Your account has been created.")


def b2():
    messagebox.showinfo("Sigh In", "Sign In your New Account")


tkinter.Button(obj, text="Create", fg="blue", bg="grey", command=b1).grid(row=14, column=1)
tkinter.Button(obj, text="Sign In", fg="blue", bg="grey", command=b2).grid(row=14, column=2)
